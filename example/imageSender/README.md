...
8. Run this command for the ImageSenderDemo
```
--localAddress 192.168.0.1 --localPort 50000 --backChannelPort 12345
```
...
Connect both connectors on RDMA crad as loopback 

- Image Sender 

1. Run this command for the ImageSenderDemo
```
--localAddress 192.168.0.1 --localPort 50000 --backChannelPort 12345
``` 
...
2. RDMA session Sending will remain in waiting state until the RDMA receiver start
```
